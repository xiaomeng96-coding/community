...
public class FollowController implements CommunityConstant {
    ...
    public String follow(int entityType, int entityId) {
        ...
        return CommunityUtil.convert2JSONString(0, "已关注");
    }
    ...
    public String unFollow(int entityType, int entityId) {
        ...
        return CommunityUtil.convert2JSONString(0, "已取消关注");
    }
    ...
    public String getFollowees(@PathVariable("userId") int userId, Page page, Model model) {
        ...
        page.setRowCounts( (int)followService.findFolloweeCount(userId, ENTITY_TYPE_USER));
    ...
    public String getFollowers(@PathVariable("userId") int userId, Page page, Model model) {
        ...
        page.setRowCounts( (int)followService.findFollowerCount(ENTITY_TYPE_USER, userId));
