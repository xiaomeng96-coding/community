...
public class LoginController implements CommunityConstant {
    ...
    public String register(Model model, User user) {
        ...
        if(map == null || map.isEmpty()) {
            model.addAttribute("msg", "注册成功，请尽快到您的邮箱点击激活邮件吧！");
    ...
    public void createKaptcha(HttpServletResponse response) {
        ...
        String redisKaptcha = RedisKeyUtil.generateKaptcha(kaptchaOwner);
        redisTemplate.opsForValue().set(redisKaptcha, text, 60, TimeUnit.SECONDS);
    ...
    public String login(String username, String password, String code, boolean rememberMe,
        ...
        if (StringUtils.isNotBlank(kaptchaOwner)) {
            String redisKey = RedisKeyUtil.generateKaptcha(kaptchaOwner);
